...
# def generate_frames(cap, model, reader, save_folder, detected_plates, sheet):
#     frame_interval = int(cap.get(cv2.CAP_PROP_FPS) / FRAME_RATE)
#     frame_count = 0
...
# def video_feed_cam1():
#     print("Request received for /api/video_feed_cam1")
#     return Response(generate_frames(cap, model, reader, save_folder, detected_plates, sheet),
#                     mimetype='video/mp4',
#                     content_type='multipart/x-mixed-replace; boundary=frame')
